...
time_vector = (0 : length(signal_tx_noisy) - 1).' * Ts;
...
symb_rx_down = downSampler(signal_rx_distorted, OSF);

time_vector_symb = (0 : length(symb_rx_down) - 1).' * Tsymb;
