function hFig = plotFilterCharacteristics(g_rrc, Beta, Fs, OSF)
    ...
    plot(time_axis_us, g_rrc, 'MarkerSize', 4, 'Marker', 'o');
    grid on; box on;
    xlabel('Time (\mus)');
    ylabel('Amplitude');
    ...
    subplot(3, 1, 3);
    h_rc = conv(g_rrc, g_rrc);      % Combined Tx+Rx filter responseµ
