function signal_out = addSyncErrors(signal_in, delta_cfo_ppm, phase_offset, sample_time_offset, Ts)
    ...
    signal_out(1:sample_time_offset) = 0;                       % Time shift (sample_shift samples)
